...
<template>
  <div class="grid gap-5 md:grid-cols-2">
    <div>
      ...
      <input
        ...
        :maxlength="100"
        toolparamdescription="The full name of the contact person"
    ...
    <div>
      ...
      <input
        ...
        type="email"
        class="rounded-2xl border border-neutral-200 px-4 py-3 text-sm inline-full user-valid:border-green-500 user-invalid:border-red-500 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 focus:outline-hidden"
        toolparamdescription="The email address of the contact person"
  ...
  <div class="grid gap-5 md:grid-cols-2">
    <div>
      ...
      <input
        ...
        class="rounded-2xl border border-neutral-200 px-4 py-3 text-sm inline-full user-valid:border-green-500 user-invalid:border-red-500 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 focus:outline-hidden"
        :maxlength="20"
        toolparamdescription="The phone/WhatsApp number of the contact person"
    ...
    <div>
      ...
      <input
        ...
        name="topic"
        type="text"
        class="rounded-2xl border border-neutral-200 px-4 py-3 text-sm inline-full focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 focus:outline-hidden"
        toolparamdescription="The specific focus or interest of the trip, e.g., Sahara desert, imperial cities, custom trek"
  ...
  <div>
    ...
    <textarea
      id="contact-message"
      name="message"
      class="rounded-2xl border border-neutral-200 px-4 py-3 text-sm inline-full min-block-40 user-valid:border-green-500 user-invalid:border-red-500 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 focus:outline-hidden"
      :maxlength="1000"
      toolparamdescription="The detailed message or description of the custom Morocco itinerary/dream tour request"
